...
public class MPBCRCD_CrossoverTaskUp implements Runnable {
    ...
    public MPBCRCD_CrossoverTaskUp(GeneticAlgorithm ga, long identity, float mutRate, Chromosome p1, Chromosome p2, Chromosome p3, int r1, int r2, int r3, boolean cross, InstancesClass data) {
        this.p1 = p1;
        this.p2 = p2;
        this.p3 = p3;
        this.r1 = r1;
    ...
    private Chromosome Crossover() {
        ...
        ArrayList<String> route,route1, tempRoute1,
                tempRoute2;
        Set<String> selectRoute;
        String patient;
        Patient p;
        if(true)
            selectRoute = new HashSet<>(p1.getGenes()[r3]);
        else
            selectRoute = new HashSet<>();
